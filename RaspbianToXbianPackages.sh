...
sudo wget http://ftp.gnome.org/mirror/cdimage/snapshot/Debian/pool/main/g/geoip-database/geoip-database_20120809-1_all.deb
sudo dpkg -i geoip-database_20120809-1_all.deb
sudo rm geoip-database_20120809-1_all.deb
