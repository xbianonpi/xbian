...
libxdmcp6 make libx11-6 libraspberrypi-doc raspberrypi-bootloader libraspberrypi0 libraspberrypi-bin
...
udisks usbmount git-core ntfs-3g wireless-tools libjasper-dev libass-dev fbset libplist1 pv exfat-fuse bc network-manager \
python-dbus usbutils --fix-missing
...
#Clone xbian git
cd /home/xbian/
git clone --depth 5 -b xbian-alpha4 https://github.com/xbianonpi/xbian.git source
cd source
...
ln -s /opt/vc/bin/vchiq_test /usr/bin/
ln -s /opt/vc/bin/edidparser /usr/bin/
ln -s /opt/vc/bin/tvservice /usr/bin/
ln -s /opt/vc/bin/vcdbg /usr/bin/
