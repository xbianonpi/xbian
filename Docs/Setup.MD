...
python-dbus usbutils console-tools watchdog libcurl3 --fix-missing
...
echo "xbian ALL=(ALL) NOPASSWD: /usr/local/sbin/xbian-config, /sbin/halt, /sbin/reboot, /bin/fbset, /usr/bin/splash, /usr/bin/pkill" >> /etc/sudoers
