...
sudo apt-get install libtiff-dev liblockdev1-dev wget rpcbind nfs-common screen git dialog libsamplerate0 libmysqlclient18 libsmbclient libssh-4 libavahi-client-dev libmicrohttpd-dev libtinyxml-dev libyajl-dev liblzo2-dev libjpeg-dev libfribidi-dev libpcre3-dev libcdio-dev libfreetype6
